...
stock_request = ErrorHandling(STOCK_ENDPOINT)
stock_response = stock_request.get_hold_of(**stock_params)
...
if stock_response:
    ...
    if percentage >= 5 or percentage <= -5:
        ...
        news_request = ErrorHandling(NEWS_ENDPOINT)
        news_response = news_request.get_hold_of(**news_params)
